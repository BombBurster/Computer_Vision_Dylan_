...
# from submodule import disparityregression
# from submodule import feature_extraction
# import submodule
...
########
        ...
        self.dres2 = nn.Sequential(submodule.convbn_3d(32, 32, 3, 1, 1),
                                   nn.ReLU(inplace=True),
                                   submodule.convbn_3d(32, 32, 3, 1, 1))
 
        self.dres3 = nn.Sequential(submodule.convbn_3d(32, 32, 3, 1, 1),
                                   nn.ReLU(inplace=True),
                                   submodule.convbn_3d(32, 32, 3, 1, 1))

        self.dres4 = nn.Sequential(submodule.convbn_3d(32, 32, 3, 1, 1),
                                   nn.ReLU(inplace=True),
                                   submodule.convbn_3d(32, 32, 3, 1, 1))
 
        self.classify = nn.Sequential(submodule.convbn_3d(32, 32, 3, 1, 1),
                                      nn.ReLU(inplace=True),
    ...
    def forward(self, left, right):
        ...
        pred = F.softmax(cost)
        pred = submodule.disparityregression(self.maxdisp)(pred)
